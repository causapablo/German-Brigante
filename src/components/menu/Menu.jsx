    ...
    return (
        <section className='relative overflow-hidden bg-black'>
            <div className='flex w-full group relative'>
                <div className='mx-auto gap-5 grid grid-cols-2 md:space-y-0 md:flex group-hover:pause whitespace-nowrap md:animate-scrolling md:animation-delay-4'>
                    <button className='w-full space-x-5 flex justify-between items-center md:h-16 px-1 md:px-8 md:text-3xl font-extrabold bg-black bg-opacity-90 text-gray-300  hover:shadow-md hover:bg-[#C21010] hover:bg-opacity-10 hover:border-2 hover:border-[#C21010] hover:duration-300' ><AiOutlineMail className='mr-5 mt-1'/>BOOKING<IoMdArrowDropright className='mt-1' /></button>
